...
public class ArraysUtility {
    ...
    public static int[] removeElementSpecificIndex(int[] array, int in) {
        ...
        for (int i = 0; i < array.length; i++) {
            if (i != index) {
                new_array[indexNewArray] = array[i];
                indexNewArray++;
            }
        }
        return new_array;
    ...
    public static int[] addElementSpecificIndex(int[] array, int in, int element) {
